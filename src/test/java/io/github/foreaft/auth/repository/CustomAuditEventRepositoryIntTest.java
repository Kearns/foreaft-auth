package io.github.foreaft.auth.repository;

import io.github.foreaft.auth.ForeaftApp;
import io.github.foreaft.auth.config.Constants;
import io.github.foreaft.auth.config.audit.AuditEventConverter;
import io.github.foreaft.auth.domain.PersistentAuditEvent;
...
import static io.github.foreaft.auth.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
